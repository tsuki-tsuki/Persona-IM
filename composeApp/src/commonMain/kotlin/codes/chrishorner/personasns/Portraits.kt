...
private fun Density.getDisplayModelFor(
    sender: Sender,
...
@Composable
private fun List<Sender>.resolveDrawableToImageBitmapByMap() = associate { sender ->
    sender to sender.image?.let { imageResource(it) }
}