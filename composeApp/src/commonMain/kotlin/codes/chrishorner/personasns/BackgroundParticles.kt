...
private fun Density.particlePathFrom(svgString: String): ParticlePath {
    val path = pathFrom(svgString)
        ...
        remember(density, season) {
            when (season) {
                ...
                Season.SPRING -> listOf(
                    particlePathFrom(Sakura1),
                    particlePathFrom(Sakura2),
                    particlePathFrom(Sakura3),
                    particlePathFrom(Sakura4),
                )

                Season.WINTER -> listOf(
                    particlePathFrom(Snowflake1),
                    particlePathFrom(Snowflake2),
                    particlePathFrom(Snowflake3),
                    particlePathFrom(Snowflake4),
                )
            }
        }
    }
