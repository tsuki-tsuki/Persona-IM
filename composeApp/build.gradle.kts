...
//                enableLanguageFeature("ExplicitBackingFields")
                // FIXME contextReceivers still can't be used in KMP until stable or compiler binary compatibility is fixed
...
android {
    namespace = "codes.chrishorner.personasns"
    ...
    defaultConfig {
        applicationId = "codes.chrishorner.personasns"
...
compose.desktop {
    application {
        mainClass = "codes.chrishorner.personasns.MainKt"
